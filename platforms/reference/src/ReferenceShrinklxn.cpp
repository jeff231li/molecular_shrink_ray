...
/**---------------------------------------------------------------------------------------
   ...
   ReferenceShrinkIxn constructor

   --------------------------------------------------------------------------------------- */

ReferenceShrinkIxn::ReferenceShrinkIxn(const Lepton::CompiledExpression& energyExpression,
...
/**---------------------------------------------------------------------------------------
   ...
   ReferenceShrinkIxn destructor

   --------------------------------------------------------------------------------------- */

ReferenceShrinkIxn::~ReferenceShrinkIxn() {
}
...
void ReferenceShrinkIxn::setUseCutoff(double distance, const OpenMM::NeighborList& neighbors) {
...
void ReferenceShrinkIxn::setInteractionGroups(const vector<pair<set<int>, set<int> > >& groups) {
...
void ReferenceShrinkIxn::setUseSwitchingFunction(double distance) {
    useSwitch = true;
...
void ReferenceShrinkIxn::setPeriodic(OpenMM::Vec3* vectors) {
...
void ReferenceShrinkIxn::calculatePairIxn(int numberOfAtoms, vector<Vec3>& atomCoordinates,
...
void ReferenceShrinkIxn::calculateOneIxn(int ii, int jj, vector<Vec3>& atomCoordinates, vector<Vec3>& forces,
                                         double* totalEnergy, double* energyParamDerivs) {
